...
import type { Product, ProductDetails, ProductId, ProductsApi } from "@mf-benchmark/contracts";
...
export function createProductsApi(opts: { delayMs: number }): ProductsApi {
    ...
    return { preload, getProductsSync, getProductDetailsSync, productsById };
}
